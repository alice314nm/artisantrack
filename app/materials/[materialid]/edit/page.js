...
import { dbAddMaterial, fetchMaterialById, fetchMaterialCategories, fetchMaterials, fetchMaterialsIds, updateMaterial } from "@/app/_services/material-service";
...
export default function Page() {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        ...
        setImageUrls([]);
        setCost(selectedMaterial.costPerUnit || 0.00);
        setLoading(false);
